...
from utils.util import get_data, prepare_cuda, train, evaluate, save_features, VISIUM_DATASETS, SPATIAL_LIBD_DATASETS
...
for dataset in datasets:
    ...
    name = args.dataset if not args.spatial else "%s_with_spatial" % args.dataset
    ...
    feature_suff = "features_linear" if args.linear_penalty else "features_switch"
