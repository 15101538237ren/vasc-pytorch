...
parser.add_argument('--expr_name', type=str, default='default') #'500_penalty1_200_penalty2_-250_penalty3_50p22_spc_0.25_ftf_0.6'
...
parser.add_argument('--n_consensus', type=int, default=10)
